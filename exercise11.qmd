...
descriptor_frequency, descriptor_year_crosstab
```

6. Which types of ‘DESCRIPTOR’ do you think should be included if our interest is rodent sighting?

If our interest is rodent sighting, the Descriptors that should be included are "Mouse Sighting," "Rat Sighting," and possibly "Rodent Bite."
...
response_time = subset.groupby('Borough')['Reponse Time'].mean().round(2)
response_time
```